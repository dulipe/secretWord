...
const Modal = ({ isOpen, title, word, definitions, onClose }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-gray-100 flex flex-col p-8 rounded-2xl shadow-2xl max-w-sm w-full mx-4 gap-6 border border-gray">

        <p className="text-2xl font-bold text-center text-gray-800">
          {title}
        </p>

        <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-sm border border-gray">
